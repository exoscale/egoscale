...
type IngressRule struct {
	...
	IcmpCode          int8   `json:"icmpcode,omitempty" doc:"the code for the ICMP message response"`
	IcmpType          int8   `json:"icmptype,omitempty" doc:"the type of the ICMP message response"`
